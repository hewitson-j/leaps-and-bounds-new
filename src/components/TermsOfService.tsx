    ...
    <div className="terms-of-service legal">
      <div className="legal-header">
        ...
        <p className="legal-updated-date">
          <b>Last updated: April 19, 2024</b>
        </p>
        <button
          onClick={() => {
            navigate("/");
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Leaps and Bounds Preschool Colorado
            Springs, 5526 Whiskey River Dr, Colorado Springs, CO 80923.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Material</strong> refers to content published on the Service
            which includes but is not limited to images, logos, written content,
            etc.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Leaps and Bounds Pre-K,
            accessible from{" "}
            <a
              href="http://www.leapsandboundsprek.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://www.leapsandboundsprek.com
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        Our Service contains images and other copyrighted Material. Material
        hosted on the Service unless explicitly stated otherwise is property of
        the Company and under copyright protection.
      </p>
      <p>
        You may not use any of the Material hosted on our Service without
        written consent by the Company. To request consent to use any of the
        copyrighted Material on this website, you may contact Us using one of
      ...
      <ul>
        ...
        <li>
          <p>
            By phone number: <a href="tel:719-439-0566">719-439-0566</a>
          </p>
        </li>
      </ul>
      <p>
        Material not under copyright or ownership of the Company is included in
        the following list:
      </p>
      <ul>
        <li>
          <p>
            The reviews posted on this website are the sole intellectual
            property of the respective authors and are subject to modification
            or removal at their discretion. The Company expressly disclaims any
            responsibility for, and does not endorse, the opinions, views, or
            factual assertions contained within such reviews.
          </p>
        </li>
      </ul>
      <p>
        In certain instances, the Company generated text and images in part with
        GPT-3 and DALL-E, a large-scale language-generation model and
        image-generation model respectively owned and operated by OpenAI, for
        this Service. Upon generating draft language and images, the Company
        reviewed, edited, and revised the language and images to their own
        liking and takes ultimate responsibility and copyright ownership for the
        co-authored Material of this Service. Included below is a full list of
        Material which was generated through this method:
      </p>
      <ul>
        <li>
          <p>
            The Company Logo found at{" "}
            <a
              href="https://leapsandboundsprek.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://leapsandboundsprek.com
            </a>
          </p>
        </li>
      </ul>
